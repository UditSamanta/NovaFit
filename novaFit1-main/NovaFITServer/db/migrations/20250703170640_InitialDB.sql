...
CREATE TABLE IF NOT EXISTS "public"."nova_chat_history" (
    "id" "uuid" DEFAULT gen_random_uuid() NOT NULL,
    "user_id" "uuid" NOT NULL,
    ...
    "message" "text",
    "response" "text",
    CONSTRAINT "nova_chat_history_message_type_check" CHECK (("message_type" = ANY (ARRAY['user'::"text", 'assistant'::"text"])))
);
...
BEGIN
  ...
  DELETE FROM public.nova_chat_history
  WHERE user_id IN (
    SELECT user_id
...
CREATE INDEX "idx_nova_chat_history_created_at" ON "public"."nova_chat_history" USING "btree" ("user_id", "created_at");
CREATE INDEX "idx_nova_chat_history_session" ON "public"."nova_chat_history" USING "btree" ("user_id", "session_id");
CREATE INDEX "idx_nova_chat_history_user_id" ON "public"."nova_chat_history" USING "btree" ("user_id");
