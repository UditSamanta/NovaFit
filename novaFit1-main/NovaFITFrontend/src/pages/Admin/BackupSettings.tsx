...
const BackupSettings: React.FC = () => {
  ...
  const [backupLocation, setBackupLocation] = useState('/app/NovaFITServer/backup'); // Default from backend
  ...
  const fetchBackupSettings = async () => {
    try {
      ...
      setBackupLocation(data.backupLocation || '/app/NovaFITServer/backup'); // Use fetched or default
    } catch (error) {
      toast({
        title: 'Error',
