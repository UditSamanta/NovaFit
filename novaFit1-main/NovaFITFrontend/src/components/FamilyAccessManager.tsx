    ...
    try {
      ...
      if (editingAccess) {
        ...
        const statusMessage = foundUserId 
          ...
          : `Access invitation sent to ${formData.family_email}. They'll have access once they create a NovaFIT account.`;
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  They'll get access once they create a NovaFIT account (if they don't have one already)
                </p>
              </div>
