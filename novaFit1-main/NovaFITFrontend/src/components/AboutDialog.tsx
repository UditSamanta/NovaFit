  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={onClose}>
      <AlertDialogContent ref={contentRef}>
        <AlertDialogHeader>
          <AlertDialogTitle>About NovaFIT</AlertDialogTitle>
          <AlertDialogDescription>
            <div className="space-y-4">
              <p>NovaFIT: Built for Families. Powered by AI. Track food, fitness, water, and health — together.</p>
              ...
              <div>
                ...
                <a href="https://github.com/CodeWithCJ/NovaFIT" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
                  GitHub repository
                </a>.
              </div>
              <div>
