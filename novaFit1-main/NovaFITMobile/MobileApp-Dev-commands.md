...
If you encounter an "SDK location not found" error when building the Android app, you need to create a `local.properties` file in the `NovaFITMobile/android/` directory. This file specifies the path to your Android SDK.

1.  Create the file: `NovaFITMobile/android/local.properties`
...
adb logcat --clear
adb logcat -s "ReactNative" "HealthConnect" "NovaFITMobile" *:E
...
cd .. # Go back to NovaFITMobile directory
uild:
