...
This section provides answers to common questions about NovaFIT.
...
*   **Is NovaFIT free?**
    NovaFIT is open-source software. Please check the project's GitHub repository for licensing details.

## Technical Questions

*   **How do I install NovaFIT?**
    Please refer to the [Installation Guide](/1.install) for detailed instructions on how to install NovaFIT using various methods.
...
*   **Reporting an issue**: If you believe you've found a bug, please report it on our [GitHub Issues page](https://github.com/CodeWithCJ/NovaFIT/issues).