...
This guide provides step-by-step instructions on how to install and deploy NovaFIT using Portainer. Portainer simplifies Docker management through a user-friendly web interface.
...
6.  **Repository URL**: Enter `https://github.com/CodeWithCJ/NovaFIT.git`
...
2.  Portainer will now pull the necessary Docker images and create the containers for NovaFIT. This process may take a few minutes depending on your internet connection.

## Step 3: Access NovaFIT

Once the stack is successfully deployed and all containers are running, you can access the NovaFIT frontend in your web browser.
...
You should now see the NovaFIT login/signup page.