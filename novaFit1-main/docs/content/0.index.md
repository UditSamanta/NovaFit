...
Welcome to the comprehensive documentation for **NovaFIT**, a self-hosted alternative to MyFitnessPal with AI-powered nutrition assistance.

## What is NovaFIT?

NovaFIT is a full-stack fitness tracking application that helps you monitor nutrition, exercise, body measurements, and achieve your health goals. Built with modern web technologies and designed for self-hosting, it provides complete control over your fitness data.
...
NovaFIT is open source software. Please check the repository for license details.