...
NovaFIT is a comprehensive fitness tracking application built with React 18 + TypeScript + Vite frontend and Node.js/Express backend, using PostgreSQL with Row Level Security.
...
- **Docker & Docker Compose**: Essential for running NovaFIT in containerized environments.
- **Git**: For cloning the NovaFIT repository.
...
The fastest way to get NovaFIT running is using our Docker helper script:
