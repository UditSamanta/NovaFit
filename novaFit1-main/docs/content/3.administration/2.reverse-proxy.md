...
This page will provide details on configuring a reverse proxy for NovaFIT.
...
This sample can be found under [sample](https://github.com/CodeWithCJ/NovaFIT/wiki/Sample-Setup)
