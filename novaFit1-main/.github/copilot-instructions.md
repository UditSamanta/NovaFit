# NovaFIT AI Coding Agent Instructions
...
- **Backend**: Node.js/Express (`NovaFITServer/`)
...
All database operations use repository pattern in `NovaFITServer/models/`:
```javascript
...
Modular integration system in `NovaFITServer/integrations/`:
...
- **Server entry**: `NovaFITServer/NovaFITServer.js` (route registration, middleware setup)
- **Frontend entry**: `src/App.tsx` (context providers, query client setup)
- **Documentation site**: `docs/` - Comprehensive Nuxt Content documentation (https://codewithcj.github.io/NovaFIT)
...
- **Live site**: https://codewithcj.github.io/NovaFIT hosted on GitHub Pages
