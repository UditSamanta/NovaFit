...
- **NovaFIT Version:** [e.g., 1.0.0, commit hash]
...
```
# Paste NovaFIT container log here
```

## Container Log for NovaFIT_Server
...
```
# Paste NovaFIT_Server container log here
```
